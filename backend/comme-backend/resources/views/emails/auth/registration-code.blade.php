...
<div style="margin: 28px 0; padding: 22px; background: #24221f; color: #fffaf1; text-align: center; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; font-size: 34px; letter-spacing: 0.28em; font-weight: 700; border-radius: 8px; box-shadow: 0 2px 8px rgba(36, 34, 31, 0.12);">
    {{ $code }}
</div>
