...
<table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="margin: 24px 0; background: #f5f0e6; border: 1px solid #ded4c3; border-radius: 8px; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; font-size: 14px; overflow: hidden;">
    <tr>
...
<div style="margin: 26px 0; padding: 16px; background: #fff2e8; border-left: 4px solid #b35900; color: #6b3500; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; font-size: 14px; line-height: 1.6; border-radius: 8px;">
